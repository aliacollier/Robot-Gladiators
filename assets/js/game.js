...
var fightOrSkip = function() {
  ...
  if (promptFight === "" || promptFight === null) {  // if (!promptFight): is the same as statment coded before!
    window.alert("You needd to provide a valid answer! Please try again.");
    return fightOrSkip();
  }
...
var fight = function(enemy) {
  while (playerInfo.health > 0 && enemy.health > 0){
    ...
    // remove enemy's healt by subtracting the amount set in the playerInfo.attack variable
...
var playerInfo = {
  ...
  upgradeAttack: function () {
    if (this.money >= 7) {
      window.alert("Upgrading player's attack my 6 for 7 dollars.");
      this.attack += 6;
      this.money -= 7;
    }
    else {
